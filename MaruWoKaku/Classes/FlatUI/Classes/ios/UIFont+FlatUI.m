...
+ (UIFont *)MPlusFontOfSize:(CGFloat)size {
    return [UIFont fontWithName:@"mplus-1c-regular" size:size];
}

+ (UIFont *)boldMPlusFontOfSize:(CGFloat)size {
    return [UIFont fontWithName:@"mplus-1c-bold" size:size];
}

+ (UIFont *)lightMPlusFontOfSize:(CGFloat)size {
    return [UIFont fontWithName:@"mplus-1c-light" size:size];
}
